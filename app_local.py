...
if __name__ == '__main__':
    print("\n" + "🔬 CV MATCHING - LOCAL TESTING MODE".center(70, "="))
    print()
    ...
    # Path ke CV (ganti dengan path CV Anda)
    CV_PATH = "cv.pdf"  # atau "path/to/your/cv.pdf"
    
    # Data lowongan (ganti sesuai kebutuhan)
    JOB_DATA = {
        'job_title': 'Operator Sablon',
        'required_skill': ['Operator', 'Sablon']  # Kosongkan [] jika hanya match dengan job title
    }
    ...
    if not os.path.exists(CV_PATH):
        print(f"❌ Error: File '{CV_PATH}' tidak ditemukan!")
        print(f"   Pastikan file CV ada di folder yang sama dengan script ini")
        print(f"   Atau gunakan full path: CV_PATH = '/path/to/your/cv.pdf'")
        exit(1)
    ...
    result = matcher.process_from_file(CV_PATH, JOB_DATA)
    
    # ========================================
    # DISPLAY RESULT
    # ========================================
    
    print("\n" + "📊 HASIL MATCHING".center(70, "="))
    print()
